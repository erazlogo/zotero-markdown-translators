...
- Note: These steps will allow you to link any Markdown application to Zotero (see Tutorial below).
### Obsidian
...
- Use shift-command-1 shortcut to link Zotero item to a Bear note (<a href="https://youtu.be/iQiYAoEaD9U">video</a>)
