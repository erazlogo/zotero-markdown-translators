...
- You __need__ a Zotero-Obsidian plugin that scales up well for a large number of sources. Plugins that rely on BibTex exports do not - searches can take several minutes for a large database. 
...
- If you can use an existing Zotero-Obsidian plugin to achieve the above conditions, go ahead (and please let me know so I can include directions in this setup). Otherwise, use my translators/shortcuts explained above.
### Network Analysis
